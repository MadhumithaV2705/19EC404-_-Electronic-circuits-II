...
# Circuit Diagram 
<img width="1536" height="1536" alt="image" src="https://github.com/user-attachments/assets/176c03a8-210c-45ea-92d4-753ce0a7f997" />

![e28cc632-706d-4def-8772-3c54eb2639b9](https://github.com/user-attachments/assets/8ef5a9df-842d-49a4-9a8c-45df69fbcff5)
...
# Tabulation
<img width="420" height="447" alt="image" src="https://github.com/user-attachments/assets/ee8f42af-df34-4074-b4e7-c86af89b8dd4" />

# Graph
<img width="1070" height="1320" alt="image" src="https://github.com/user-attachments/assets/35229ac4-3f53-482c-ad6b-800ca7a1900f" />
...
|:----:|-------------|:----------------:|:--------------:|
| 1 | Lower cut-off frequency | f1 = 90 Hz | f1'' = 110 Hz |
| 2 | Upper cut-off frequency | f2 = 400 KHz | f2'' = 109 KHz |
| 3 | Bandwidth | \( BW = fh - fl = 390 Hz) | \( BW = f'h - f'l = 10 KHz) |
| 4 | Mid-band Gain | \( A{v(mid)} = 18.31) | \( A'{v(mid)} = 17.19) |
| 5 | Gain at half power point | G0 = 14.31  | G0'' = 15.19 |
